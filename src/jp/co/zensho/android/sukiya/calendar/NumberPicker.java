   ...
   /**
    ...
    protected void setWidgetResource() {
        ...
        try {
...

            {
                ...
                this.incrementButton.setBackground(internalIncrementButton.getBackground());
            }

            {
                ...
                this.text.setBackground(internalText.getBackground());
...

            {
                ...
                this.decrementButton.setBackground(internalDecrementButton.getBackground());
            }
    ...
    private class NumberPickerInputFilter implements InputFilter {
        public CharSequence filter(CharSequence source, int start, int end,
            ...
            String str = result.toLowerCase(Locale.JAPAN);
            for (String val : displayedValues) {
                val = val.toLowerCase(Locale.JAPAN);
    ...
    private int getSelectedPos(String str) {
        if (this.displayedValues == null) {
            ...
            for (int i = 0; i < this.displayedValues.length; i++) {
                ...
                str = str.toLowerCase(Locale.JAPAN);
                tmp = this.displayedValues[i];
                tmp = tmp.toLowerCase(Locale.JAPAN);
