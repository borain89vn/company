...
import jp.co.zensho.android.sukiya.common.HolidayUtil;
...
public class DateInfo implements Parcelable {
    ...
    public DateInfo(int year, int month, int day) {
        ...
        this.isHoliday = 
            ...
            || !StringUtils.isEmpty(this.holidayName);
    }
    /**
     * コンストラクタ
    ...
    public Date createDate() {
        this.reportDate = DateUtils.date(year, month, day, hour, minute, 0);
    ...
    public String toString() {
        SimpleDateFormat sdf = new SimpleDateFormat("YYY/MM/DD HH:mm", Locale.JAPAN);
        
        StringBuilder builder = new StringBuilder();
        builder.append("DateInfo [");
        builder.append(" Date[year/month/day hour:minute] = [");
        builder.append(sdf.format(reportDate));
        builder.append(", isHoliday = " + this.isHoliday);
        if (!StringUtils.isEmpty(this.holidayName)) {
            builder.append(", ").append(this.holidayName);
        }
        if (!StringUtils.isEmpty(this.holidayName)) {
            builder.append(", ").append(this.holidayName);
        }
