...
public class SukiyaNumberKeyboardPartCode {
     ...
     */
    public SukiyaNumberKeyboardPartCode(Activity host, int viewid, int layoutid) {
        mHostActivity = host;
    ...
    private boolean acceptNumber(String strVal, int index) {
        ...
        try {
            ...
            //if (dblVal < 1000) {
                ...
                if (dotIndex > -1 && index > dotIndex && (strVal.length() - dotIndex) > 15) {
                    return false;
                }
                if (strVal.length() > 15 && dotIndex == -1) {
                    return false;
                } else if (dotIndex > 0) {
                    return false;
                }
